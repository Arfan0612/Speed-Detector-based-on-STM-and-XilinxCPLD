/*
  Library:        lcd16x2_v2 - Parallel 8/4 bits
  Written by:     Mohamed Yaqoob
  Date Written:   04/12/2017
  Updated:        26/06/2020 
                  23 Nov 2021 (Compatibile with STM32L476RG Nucleo-64)
...
static GPIO_TypeDef* PORT_RS, *PORT_E;               // RS and E PORT
static uint16_t PIN_RS, PIN_E;                    // RS and E pins
static GPIO_TypeDef* PORT_LSB_D0, *PORT_LSB_D1, *PORT_LSB_D2, *PORT_LSB_D3;  // LSBs D0, D1, D2 and D3 PORT
static uint16_t D0_PIN, D1_PIN, D2_PIN, D3_PIN;   // LSBs D0, D1, D2 and D3 pins
static GPIO_TypeDef* PORT_MSB_D4, *PORT_MSB_D5, *PORT_MSB_D6, *PORT_MSB_D7, *backlight_PORT;  // MSBs D5, D6, D7 and D8 PORT
static uint16_t D4_PIN, D5_PIN, D6_PIN, D7_PIN, backlight_PIN;   // MSBs D5, D6, D7 and D8 pins
#define T_CONST   20
...
void lcd16x2_init_8bits(
    ...
    GPIO_TypeDef* port_d0, uint16_t d0_pin, GPIO_TypeDef* port_d1, uint16_t d1_pin, GPIO_TypeDef* port_d2, uint16_t d2_pin, GPIO_TypeDef* port_d3, uint16_t d3_pin, 
