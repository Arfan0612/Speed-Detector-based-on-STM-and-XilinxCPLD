/*
  ...
  Description:    This is a library for the standard 16X2 LCD keypad shield display, for the STM32L476RG Nucleo-64 MCUs based on HAL libraries.
...
#ifndef LCD16X2_H_V2_
#define LCD16X2_H__V2_
